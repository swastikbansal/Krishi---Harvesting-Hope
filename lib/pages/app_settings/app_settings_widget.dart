                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'p0gd70l0' /* IEEE SIGHT Group of AITR */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                            ...
                            children: [
                              Align(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'APP_SETTINGS_PAGE_youtube_ICN_ON_TAP');
                                    await launchURL(
                              ...
                              Align(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'APP_SETTINGS_PAGE_instagram_ICN_ON_TAP');
                                    await launchURL(
                              ...
                              Align(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'APP_SETTINGS_PAGE_github_ICN_ON_TAP');
                                    await launchURL(
                              ...
                              Align(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'APP_SETTINGS_PAGE_linkedinIn_ICN_ON_TAP');
                                    await launchURL(
